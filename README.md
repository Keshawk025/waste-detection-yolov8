...
1. Input image or camera feed is captured
2. YOLOv8 model processes the frame
3. Waste objects are detected and classified
4. Results are displayed with bounding boxes and labels
...
- Deploy on edge devices (Raspberry Pi, Jetson Nano)</content>
